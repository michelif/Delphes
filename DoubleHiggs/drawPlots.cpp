...
int main(int argc, char* argv[]) {
  ...
  outputdir_str+=argv[1];
  outputdir_str.erase(outputdir_str.end()-5,outputdir_str.end());
  ...
  db_nostack->add_mcFile( DoubleHiggsFile, "HH", "HH(\\rightarrow bb#gamma#gamma)",signalFillColor,3004);
  db_nostack->drawHisto_fromTree("tree_passedEvents", "ptPhot1", "eventWeight", 50, 20., 400, "ptPhot1", "p_T Lead Photon (GeV)");
  db_nostack->drawHisto_fromTree("tree_passedEvents", "etaPhot1", "eventWeight", 15, -3., 3., "etaPhot1", "#eta Lead Photon");
  db_nostack->drawHisto_fromTree("tree_passedEvents", "ptPhot2", "eventWeight", 50, 20., 400, "ptPhot2", "p_T Sublead Photon (GeV)");
  db_nostack->drawHisto_fromTree("tree_passedEvents", "etaPhot2", "eventWeight", 15, -3., 3., "etaPhot2", "#eta Subead Photon ");
  ...
  db_nostack->drawHisto_fromTree("tree_passedEvents", "deltaRGammaGamma", "eventWeight", 30, 0., 5., "deltaRGammaGamma", "#Delta_{R}(#gamma #gamma)");
  ...
  db_nostack->drawHisto_fromTree("tree_passedEvents", "deltaRBB", "eventWeight", 30, 0., 5., "deltaRBB", "#Delta_{R}(bb)");
  ...
  db_nostack->drawHisto_fromTree("tree_passedEvents", "mgg", "eventWeight", 25, 100., 150., "mgg", "m_{#gamma#gamma} (GeV)");
  db_nostack->drawHisto_fromTree("tree_passedEvents", "mbb", "eventWeight", 60, 60., 180., "mbb", "m_{bb} (GeV)");
}
